    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        ...
        <p className="max-w-sm text-neutral-700 text-sm md:text-base dark:text-neutral-300">
          My career path and professional development over the years.
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-[0%] from-amber-500 via-[10%] via-orange-500 to-transparent"
          />
        </div>
      </div>
    </div>
